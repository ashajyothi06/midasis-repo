      ...
      <section className="w-full py-10 md:py-14">
        <div className="max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[5fr_2fr] gap-10 px-4 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            {/* TEXT CONTENT */}
            <div className="space-y-7 leading-relaxed text-slate-800">
              <div>
                <h2
                  className="mb-3"
                  style={{
                ...
                >
                  ...
                  systems not only meet today’s needs but are future-proofed for
                  tomorrow.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  Our approach is centered around performance optimization, rapid
                  response, security, and innovation. We don’t just maintain
                  applications—we transform them into powerful, reliable tools that
                  give your organization a competitive edge. Our expert IT consultants
                  have deployed cutting-edge solutions across telecommunications,
                  automotive, healthcare, insurance, finance, retail, airlines, and
                  more.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  We understand the critical nature of uptime for your business
                  operations. Our dedicated teams are ready to respond immediately to
                  issues as they arise. We prioritize fast turnaround times, minimizing
                  downtime and ensuring your applications remain operational, secure,
                  and efficient.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 list-disc list-inside">
                  ...
                  >
                    ...
                    Seamless migration to new platforms or cloud environments with
                  ...
                  >
                    ...
                    Redesign existing applications for improved functionality,
                  ...
                  >
                    ...
                    Continuous monitoring, tuning, and upgrades to keep your
              ...
              <div>
                ...
                >
                  ...
                  Insurance, Finance and Banking, Retail, and Airlines. We provide
                  tailored solutions for each sector, ensuring your applications
                  support your business goals without fail.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  application processes while maintaining the highest levels of
                  security and performance, giving you a clear competitive edge.
                </p>
              </div>
