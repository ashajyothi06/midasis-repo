      ...
      <section className="w-full py-10 md:py-14">
        ...
        >
          ...
          <div className="space-y-8">
            {/* HERO IMAGE */}
            <div
              className="w-full h-[380px] md:h-[500px] lg:h-[560px]
            ...
            <div className="space-y-7 leading-relaxed">
              ...
              <div>
                ...
                >
                  ...
                  <li>
                    ...
                    Solutions that improve performance, reduce costs, and deliver
                    measurable results.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                >
                  <li>
                    <strong className="text-[#0a0a0a]">AI Services:</strong> Automation,
                    intelligence & insights.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Cloud Solutions:</strong> AWS,
                    Azure, Google Cloud migration & optimization.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Database Management:</strong>{" "}
                    Secure, structured, performance-driven systems.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Data Warehouse & BI:</strong>{" "}
                    Analytics, dashboards, smarter decisions.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Web Development:</strong> Scalable
                    modern web architecture.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Business Analysts:</strong>{" "}
                    Domain-specific consulting expertise.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Project Management:</strong>{" "}
                    PMI-certified experts ensuring delivery success.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">UNIX & Network Admin:</strong>{" "}
                    High-availability enterprise systems.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">Security Admin:</strong> Threat
                    protection & security frameworks.
                  </li>
                  <li>
                    <strong className="text-[#0a0a0a]">ERP Resources:</strong> Optimizing
              ...
              <div>
                ...
                >
                  ...
                  <strong className="text-[#0a0a0a]">972-782-2529</strong> to begin your
