          ...
          <div className="space-y-8">
            ...
            <div className="space-y-7 text-base md:text-lg text-slate-800 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Real-time ticketing via VMSD and customer ticketing portals
                </li>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Leverage both open-source and commercial threat intelligence feeds
                </li>
                <li>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Support for setting up CSIRT (Computer Security Incident Response Team)</li>
